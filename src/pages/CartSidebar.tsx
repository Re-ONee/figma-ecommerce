...
import AsgaardSofaSection1 from "../components/AsgaardSofaSection1";
  ...
  return (
    <div className={styles.cartSidebar}>
      ...
      <RelatedProductsSection
        iconCode="/comparesvgrepocom-1.svg"
        iconTextCode="/comparesvgrepocom-1.svg"
        iconSizeCode="/heart1.svg"
        new1={false}
        popUp={false}
        fixPrice={false}
        label={false}
      ...
      <div className={styles.rectangleGroup}>
        ...
        <div className={styles.frameParent}>
          <div className={styles.cartWrapper} onClick={onFrameContainerClick}>
            <div className={styles.cart}>Cart</div>
          </div>
          <div className={styles.cartWrapper} onClick={onFrameContainer1Click}>
            <div className={styles.cart}>Checkout</div>
          </div>
          <div className={styles.cartWrapper} onClick={onFrameContainer2Click}>
            <div className={styles.cart}>Comparison</div>
          </div>
        </div>
        <div className={styles.groupChild2} />
        <div className={styles.subtotal}>Subtotal</div>
        <div className={styles.rs52000000}>Rs. 520,000.00</div>
      </div>
    </div>
  );
};
